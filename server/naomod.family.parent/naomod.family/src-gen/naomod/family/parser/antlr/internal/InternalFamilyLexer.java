...
public class InternalFamilyLexer extends Lexer {
    ...
    public final void mRULE_NAME() throws RecognitionException {
        try {
            int _type = RULE_NAME;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:275:11: ( 'A' .. 'Z' ( 'a' .. 'z' )* ( '-' 'A' .. 'Z' ( 'a' .. 'z' )* )? )
            // InternalFamily.g:275:13: 'A' .. 'Z' ( 'a' .. 'z' )* ( '-' 'A' .. 'Z' ( 'a' .. 'z' )* )?
            {
            matchRange('A','Z'); 
            // InternalFamily.g:275:22: ( 'a' .. 'z' )*
            loop1:
            do {
                int alt1=2;
            ...
            // InternalFamily.g:275:34: ( '-' 'A' .. 'Z' ( 'a' .. 'z' )* )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalFamily.g:275:35: '-' 'A' .. 'Z' ( 'a' .. 'z' )*
                    {
                    match('-'); 
                    matchRange('A','Z'); 
                    // InternalFamily.g:275:48: ( 'a' .. 'z' )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:277:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalFamily.g:277:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalFamily.g:277:11: ( '^' )?
            int alt4=2;
            ...
            // InternalFamily.g:277:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:279:10: ( ( '0' .. '9' )+ )
            // InternalFamily.g:279:12: ( '0' .. '9' )+
            {
            // InternalFamily.g:279:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:281:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalFamily.g:281:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalFamily.g:281:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalFamily.g:281:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalFamily.g:281:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalFamily.g:281:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalFamily.g:281:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:283:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalFamily.g:283:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalFamily.g:283:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:285:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalFamily.g:285:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalFamily.g:285:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:287:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalFamily.g:287:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalFamily.g:287:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFamily.g:289:16: ( . )
            // InternalFamily.g:289:18: .
            {
            matchAny(); 
